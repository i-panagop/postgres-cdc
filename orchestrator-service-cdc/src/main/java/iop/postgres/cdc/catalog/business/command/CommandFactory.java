...
import iop.postgres.cdc.catalog.business.commerceitem.CommerceItemEvent;
import iop.postgres.cdc.catalog.business.event.Event;
import iop.postgres.cdc.catalog.business.event.EventType;
import iop.postgres.cdc.catalog.business.order.OrderEvent;
import iop.postgres.cdc.catalog.business.order.UpdateOrderCommand;
import iop.postgres.cdc.catalog.business.payment.CreatePaymentCommand;
import iop.postgres.cdc.catalog.business.payment.PaymentEvent;
import iop.postgres.cdc.catalog.business.shipping.CreateShippingCommand;
import iop.postgres.cdc.catalog.business.shipping.ShippingEvent;
